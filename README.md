...
## App and Package Generation

`nx g @nx/js:lib libs/contracts --importPath=@enterprise/contracts`

No build libraries that can be used on both react and nestjs projects. Choose the no build options.

`nx g @nx/react:app apps/my-new-app`

Use this to generate new react projects. Please make sure it doesnt override the react and react dom versions. Please also dont setup the router when you do this, it may messup the react versions.

Need to be extra careful because in NX monorepos, only 1 package.json exists
